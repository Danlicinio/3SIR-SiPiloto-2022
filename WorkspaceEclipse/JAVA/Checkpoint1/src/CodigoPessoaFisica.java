...
public class CodigoPessoaFisica {
	...
	public boolean validaCPF(String CPF) {
		...
		if (CPF.equals("00000000000") || CPF.equals("11111111111") || CPF.equals("22222222222") || 
			...
			try {
				// Cálculo do 1o. Digito Verificador sm = 0;
				sm = 0;
				peso = 10;
				for (i = 0; i < 9; i++) {
					// converte o i-esimo caractere do CPF em número: // por exemplo, transforma o caractere '1' no nro 1 // (48 eh a posicao de '0' na tabela ASCII)
				...
				peso = 11;
				for (i = 0; i < 10; i++) {
					num = (int) (CPF.charAt(i) - 48); sm = sm + (num * peso);
					peso = peso - 1;
				...
				if ((r == 10) || (r == 11))
					dig11 = '0'; else
						dig11 = (char) (r + 48); //caractere numérico dígitos informados.
